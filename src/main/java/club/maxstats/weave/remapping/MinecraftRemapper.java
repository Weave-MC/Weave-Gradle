...
public class MinecraftRemapper extends SimpleRemapper {
    ...
    private static Map<String, String> parseMappings(String version) {
        ...
        try (var stream = WeavePlugin.class.getResourceAsStream("/mappings/lunar_named_b2_" + version + ".xsrg")) {
            if (stream == null) {
            ...
            while (reader.ready()) {
                ...
                switch (line.substring(0, 4)) {
                    ...
                    case "MD: " -> {
                        ...
                        mappings.put(
                            String.format("%s.%s%s", clazz, method, split[1]),
